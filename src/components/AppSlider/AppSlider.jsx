...
const AppSlider = () => {
  ...
  return (
    <div className="py-4 md:mt-16 mx-auto overflow-hidden lg:container">
      <div className="w-11/12 mx-auto">
        <div className="pb-2 text-center">
          <h2 className="text-3xl font-bold mb-1">
            Play on the big <span className="text-primary">screen</span>
          </h2>
          <p className="text-gray-500 text-sm w-full sm:w-1/2 mx-auto mt-2">
            ...
            experience home and immerse yourself in stunning visuals and
            powerful sound on the big screen.
          </p>
        </div>
