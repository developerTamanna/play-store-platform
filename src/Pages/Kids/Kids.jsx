...
const Kids = () => {
 ...
 <>
  <section className="bg-yellow-200 text-gray-800 mt-20">
    <div className="relative group hover:shadow-2xl hover:scale-[1.02] duration-300 container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between overflow-hidden rounded-lg">
      ...
      <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
        <h1 className="text-5xl font-bold leading-none sm:text-6xl">
          Celebrate <span className="text-violet-600">Golden</span> Week With Sago Mini
        </h1>
...
<section className="bg-white py-12 px-4 mt-10">
  <div className="max-w-7xl mx-auto">
    <h2 className="text-3xl font-bold text-center mb-10">Recommended for you</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-20">
      ...
      {[
        ...
        <div key={i} className="bg-yellow-100 rounded-xl shadow-md p-4 flex flex-col items-center text-center hover:scale-105 transition-transform duration-300 group">
...
<section className="bg-pink-50 py-12 px-4 mt-20">
  <div className="max-w-7xl mx-auto">
    <h2 className="text-3xl font-bold text-center mb-10 text-pink-600">Kids Reviews</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition duration-300">
        ...
        <p className="text-gray-600 italic">"I love this game! It's super fun and I learned ABC too!"</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition duration-300">
        ...
        <p className="text-gray-600 italic">"Drawing game is my favorite! I made a rainbow!"</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition duration-300">
        ...
        <p className="text-gray-600 italic">"Mom said I can play everyday. It's so cool!"</p>
      </div>
    </div>
  </div>
</section>
